return {--[[ #PVF_File ]]
	...
	["[attack kind]"]={15.00,1.00,1.00,1,0,0,0,0,0,0,0,0,100.00,0.00,0.00,0,50,0,50,0,50,0,50,0,},
	...
	["[speech on situation]"]={
		...
		"[on etc]","啊啊……我要全部……杀掉！！！",0,
		"[on etc]","我的热血正在沸腾……",0,
		"[on village]","哥布林不发威，就当我是牛头怪？",0,
		"[on village]","这是哪里？我又是谁？",0,
		"[on village]","这里也没什么特别的嘛~",0,
		"[on village]","我有点后悔了……",0,
		"[on village]","别打我！",0,
		"[on village]","我只是来散步的！",0,
		"[on village]","嘿嘿，给你添麻烦了，对不起啊！",0,
		"[on village]","这只是个卑鄙的借口！",0,
	},
}