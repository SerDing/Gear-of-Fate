return {--[[ #PVF_File ]]
	...
	["[monster]"]={
		...
		-- 5,0,6,749,191,0,1,1,"[fixed]","[normal]",
		-- 5,0,6,378,199,0,1,1,"[fixed]","[normal]",
		-- 5,0,6,359,325,0,1,1,"[fixed]","[normal]",
		-- 5,0,6,638,337,0,1,1,"[fixed]","[normal]",
	},

	["[monster specific AI]"]={"[normal]","[normal]","[normal]","[normal]","[normal]","[normal]","[normal]",},

	["[special passive object]"]={826,492,240,0,1,"[trap]",17031,-1,6,6,-1,},
