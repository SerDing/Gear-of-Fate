return {--[[ #PVF_File ]]
	...
	["[pathgate pos]"]={16,216,1104,216,560,144,560,348},

	["[dungeon start area]"]={787,330,123,46},
	...
	["[monster]"]={1,1,0,436,168,0,1,1,"[fixed]","[normal]",1,1,0,247,247,0,1,1,"[fixed]","[normal]",1,1,0,474,263,0,1,1,"[fixed]","[normal]",1,1,0,353,271,0,1,1,"[fixed]","[normal]",},

	["[monster specific AI]"]={"[normal]","[normal]","[normal]","[normal]",},

	["[event monster position]"]={417,296,0,355,178,0,307,297,0,292,174,0,},
