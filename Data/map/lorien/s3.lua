return {--[[ #PVF_File --]]
	...
	["[pathgate pos]"]={15,233,1105,226,608,168,560,348},
	
	["[dungeon start area]"]={775,314,119,50},
	
	["[virtual movable area]"] ={16,233-80,1105,216,},
	...
	["[monster]"]={
		...
		5,0,6,564,220,0,1,1,"[fixed]","[normal]",
		5,0,6,610,309,0,1,1,"[fixed]","[normal]",
		1,1,0,669,216,0,1,1,"[fixed]","[normal]",
		1,1,0,495,269,0,1,1,"[fixed]","[normal]",
		1,1,0,746,293,0,1,1,"[fixed]","[normal]",
		1,1,0,197,243,0,1,1,"[fixed]","[normal]",
		1,1,0,875,297,0,1,1,"[fixed]","[normal]",
		5,0,6,448,315,0,1,1,"[fixed]","[normal]",
		1,1,0,912,220,0,1,1,"[fixed]","[normal]",
		1,1,0,415,203,0,1,1,"[fixed]","[normal]",
		1,1,0,925,314,0,1,1,"[fixed]","[normal]",
		1,1,0,381,322,0,1,1,"[fixed]","[normal]",
		1,1,0,306,306,0,1,1,"[fixed]","[normal]",
		1,1,0,536,270,0,1,1,"[fixed]","[normal]",
	},
	...
	["[special passive object]"]={826,388,252,0,1,"[trap]",17031,-1,6,6,-1,},
